...
| --------- | ----------- | ------- |
| `icinga2.config.ticket_salt` | Salt used to generate API tickets for satellites and agents | - |
| `icingaweb2.auth.admin_password` | Password for the Icinga Web 2 admin user | Only needs to be set if Icingaweb2 is `enabled` |
| `global.api.users.director.password` | Password for the Icinga Director API user | Only needs to be set if Director is `enabled` |
| `global.api.users.icingaweb.password` | Password for the Icingaweb2 API user| Only needs to be set if Icingaweb2 is `enabled` |
...
| `global.databases.<database>.username` | Username for the respective database | `string` | `<database>` |
| `global.databases.<database>.password` | Password for the respective database | `string` | **not set** |
...
| `icingaweb2.auth.admin_password` | Admin password of the IcingaWeb2 authentication | `string` | **not set** |
